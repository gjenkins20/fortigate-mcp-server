...
class FortiGateFormatters:
    ...
    def format_device_status(
        device_id: str, status_data: Dict[str, Any]
    ) -> List[Content]:
    ...
    @staticmethod
    def format_firewall_policy_detail(
    ...
    def format_error_response(
        operation: str, device_id: str, error: str
    ) -> List[Content]:
    ...
    def format_connection_test(
        device_id: str, success: bool, error: Optional[str] = None
    ) -> List[Content]:
