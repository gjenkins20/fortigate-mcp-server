...
class FortiGateAPI:
    ...
    def __init__(self, device_id: str, config: FortiGateDeviceConfig):
        ...
        if config.api_token:
            ...
            raise ValueError(
                f"Device {device_id}: Either api_token or"
    ...
    def _make_request(
        ...
        try:
            with httpx.Client(
                verify=self.config.verify_ssl, timeout=self.config.timeout, auth=auth
            ) as client:
                ...
                log_api_call(
                    self.logger, method, endpoint, response.status_code, duration_ms
                )
    ...
    def update_firewall_policy(
        self, policy_id: str, policy_data: Dict[str, Any], vdom: Optional[str] = None
    ) -> Dict[str, Any]:
    ...
    def update_address_object(
        ...
        return self._make_request(
            "PUT", f"cmdb/firewall/address/{address_name}", data=address_data, vdom=vdom
        )

    def delete_address_object(
    ...
    def update_static_route(
        self, route_id: str, route_data: Dict[str, Any], vdom: Optional[str] = None
    ) -> Dict[str, Any]:
    ...
    def update_virtual_ip(
        self, vip_name: str, vip_data: Dict[str, Any], vdom: Optional[str] = None
    ) -> Dict[str, Any]:
...
class FortiGateManager:
    ...
    def __init__(
        self, devices: Dict[str, FortiGateDeviceConfig], auth_config: AuthConfig
    ):
